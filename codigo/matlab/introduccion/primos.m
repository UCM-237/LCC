...
%del 3
s=3;
% creamos un bucle while, que realiza las iteraciones necesarias hasta  
% tener los n números primos deseados.
while j<n
    % creamos un bucle for que recorra todos los primos encontrados hasta 
    % la fecha
