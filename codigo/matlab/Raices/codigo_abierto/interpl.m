function [raiz,err,iter,tiempo]=interpl(fun,a,b,tol,maxiter,dibu)
%[raiz,err,iter]=interp('fun',a,b,tol,maxiter,dibu)
...
%
%[raiz,err,iter]=interp('fun',a,b,tol,maxiter)
...
%iter contiene el número de iteraciones empleado para alcanzar la raiz con
%la tolerancia pedida

%evaluamos la funcion en los extremos del intervalo para confirmar que
...
if nargin==6
    ...
    plot(x,y)
    hold on
    %pintamos los puntos del intervalos y la linea que los une
