function [ x,it,tolf] =SOR(A,b,tol,maxiter,w,gr)
%uso[ x,it,tolf] =,wSOR(A,b,tol,maxiter)
...
%la cual se considera que la solucion alcanzada es valida, w: parámetro
%de relajacion ,maxiter: numero maximo de iteraciones que se permite
%ejecutar al algoritmo sin encontrar la solución, gr si se incluye esta
%variable, con un valor cualquiera, el programa va pintando la evolución de
%la diferencia entre dos soluciones sucesivas.
