...
\begin{align*}
	I(y)&\approx \sum_{i=0}^{n-2}\int_{x_i}^{x_{i+2}}P_2(x)dx=\sum_{i=0}^{n-2}\frac{h}{3}(y_{2i}+4y_{2i+1}+y_{2i+2})\\
...
\begin{align*}
	I(y)&\approx \sum_{i=0}^{n-2}\int_{x_i}^{x_{i+3}}P_3(x)dx=\sum_{i=0}^{n-2}\frac{3h}{8}(y_{3i}+3y_{3i+1}+3y_{3i+2}+y_{3i+3})\\
